...
export function NoAgentNotification(props) {
  ...
  return (
    <>
      {showNotification && (
        <div className="fixed text-sm left-1/2 max-w-[90vw] w-full -translate-x-1/2 flex top-6 items-center gap-4 bg-[#1F1F1F] px-4 py-3 rounded-lg">
          <div>
            {/* Warning Icon */}
            <svg
              width="24"
